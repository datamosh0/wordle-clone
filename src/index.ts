...
const change = document.querySelector(".change") as HTMLElement;
const openModal = document.querySelector(".openModal") as HTMLElement;
...
const changeTheme = (bgColor: string, textColor: string) => {
  document.querySelector("body").style.background = `${bgColor}`;
  (
    document.querySelector(".wordle") as HTMLElement
...
change.addEventListener("click", function () {
  ...
  startInteraction();
  (document.querySelector(".reset") as HTMLElement).style.display = "none";
...
function checkWinLose(guess: string, tiles: HTMLElement[]) {
  if (guess === targetWord) {
    ...
    danceTiles(tiles);
    stopInteraction();
    (document.querySelector(".reset") as HTMLElement).style.display = "block";
